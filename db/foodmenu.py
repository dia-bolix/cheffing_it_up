...
food = {TEST_MENU: {NAME: 'CAKE', MEAL_OF_DAY: 'ANY TIME', INGREDIENTS: "MAGIC, SUGAR", CALORIES: 10, 
             ...
             'Pumpkin Pie': {NAME: "PUMPKIN PIE", MEAL_OF_DAY: "DEssert", 
                            INGREDIENTS: "Pumpkin flour, butter, egg, cornstarch, cinnamon, nutmeg, salt, milk, cream",
                             CALORIES: 323, MACRONUTRIENTS: "Fats: 13g, Carbs: 46g, Protein: 52.g", 
